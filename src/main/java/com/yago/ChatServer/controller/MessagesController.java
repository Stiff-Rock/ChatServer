...
public class MessagesController {
    ...
    public Message sendMessage(@RequestBody MessageDTO messageDTO) {
         new Message(messageDTO.getSender(), messageDTO.getChat(), messageDTO.getChat().getParticipants(), messageDTO.getMessageContent(), LocalDateTime.now());

        Message message = messageService.saveMessage(message);
